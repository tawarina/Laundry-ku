            ...
            <?php else: ?>
                <h1 class="text-center">Status</h1>
                  <section class="multi_step_form bg-light pb-4">  
                    <div id="msform"> 
                      <ul id="progressbar">
                        <li class="<?=($data[0]['prosescuci']=='1')?'active':'';?>">Proses Cuci</li>  
                        <li class="<?=($data[0]['proseskering']=='1')?'active':'';?>">Proses Pengeringan</li> 
                        <li class="<?=($data[0]['prosesstrika']=='1')?'active':'';?>">Strika</li>
                        <li class="<?=($data[0]['bisadiambil']=='1')?'active':'';?>">Siap diambil</li>
                  ...
                  <div class="row justify-content-center ">
                    <div class="col-lg-12">
                       <div class="table-responsive">
                        <table class="table table-bordered table-striped" align="center" id="dataTable" width="60%" cellspacing="0">
                          <thead>
